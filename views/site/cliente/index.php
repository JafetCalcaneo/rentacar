...
<section class="banner" style="background: url(<?= '/img/bg/'.$url?>) no-repeat;">
	<div class="container"> 
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					<div class="divider mb-3"></div>
					<span class="text-uppercase text-sm letter-spacing ">Soluciones totales en transporte inmediato</span>
					<h1 class="mb-3 mt-3">RentaCar tu mejor experiencia</h1>
...
<section class="features isDark">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 flexy">

      <?= ListView::widget([
        'dataProvider' => $servicios,
        'options' => [
            'class' => 'feature-block d-lg-flex',
        ],
...
<section class="section about isDark">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
                <?= Html::img(Url::to('@web/img/about/img-1.jpg'), ['alt' => 'auto', 'class' => 'img-fluid']) ?>
                <?= Html::img(Url::to('@web/img/about/img-2.jpg'), ['alt' => 'auto', 'class' => 'img-fluid mt-4']) ?>
...
<section class="cta-section isDark">
	<div class="container">
...
<section class="section service gray-bg isDark2">
	<div class="container">
...
<section class="section appoinment isDark">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6 ">
...
<section class="section testimonial-2 gray-bg isDark2">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7">
...
<section class="section clients isDark">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7">
				<div class="section-title text-center">
