 ...
 * @property string $pro_descripcion Descripcion
 * @property string $pro_imagen Imagen
 * @property string $pro_fechaInicio Fecha Inicio
 * @property string $pro_fechaFinal Fecha Final
 * @property float $pro_descuento Descuento
 * @property int $pro_fkauto Auto
 *
...
class RenPromocion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['pro_descripcion', 'pro_imagen', 'pro_fechaInicio', 'pro_fechaFinal', 'pro_descuento', 'pro_fkauto'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pro_imagen' => Yii::t('app', 'Imágen'),
            'pro_fechaInicio' => Yii::t('app', 'Fecha de Inicio'),
