 ...
 * @property string $cli_paterno Paterno
 * @property string $cli_materno Materno
 * @property string $cli_telefono Telefono
 * @property string $cli_fechaNacimiento Fecha Nacimiento
 *
...
class RenCliente extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cli_paterno' => Yii::t('app', 'Apellido Paterno'),
            'cli_materno' => Yii::t('app', 'Apellido Materno'),
