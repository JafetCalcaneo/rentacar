 ...
 * @property string $ren_fechaPago Fecha Pago
 * @property string $ren_fechaInicio Fecha Inicio
 * @property string $ren_fechaFinal Fecha Final
 * @property string $ren_fechaEntregado Fecha Entregado
 * @property float $ren_monto Monto
 * @property int $ren_promocion Promocion
 * @property int $ren_fkmetodoPago Metodo Pago
 * @property int $ren_fkcliente Cliente
 * @property int $ren_fkauto Auto
 *
